...
export default function CartScreen() {
    ...
    return (
        <section className="cart bg-[#e6e6e6] px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            {/* Header Section */}
            ...
            {products.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 sm:py-16 text-center" data-aos="zoom-in">
                    {/* Icon */}
                    <div className="h-24 w-24 sm:h-32 sm:w-32 rounded-full bg-[#e6e6e6] flex items-center justify-center mb-6
                    ...
                    <Link
                        href="/products"
                        className="bg-[#e6e6e6] text-emerald-700 font-semibold py-3 px-6 sm:py-3.5 sm:px-8 rounded-xl transition-all flex items-center gap-2 text-sm sm:text-base mb-10 sm:mb-12
                    ...
                    {/* Divider */}
                    <hr className="w-full max-w-md border-gray-300/60 mb-6 sm:mb-8" />

                    {/* Popular Categories */}
                    <p className="text-gray-500 font-medium mb-4 text-sm">Popular Categories</p>
                    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 px-4">
                        <Link href="/categories" className="px-4 py-1.5 sm:px-5 sm:py-2 rounded-full text-xs sm:text-sm font-medium text-gray-700 bg-[#e6e6e6] transition-all
