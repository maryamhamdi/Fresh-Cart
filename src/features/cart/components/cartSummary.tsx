...
export default function OrderSummary({ info }: OrderSummaryProps) {
	...
	return (
		<aside className="bg-[#e6e6e6] rounded-2xl sm:rounded-3xl overflow-hidden
			...
			<div className="p-4 sm:p-5 lg:p-6 space-y-4 sm:space-y-5">
				{priceForShipping < 500 ? (
					<div className="bg-[#e6e6e6] rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-start gap-3
						shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]">
						<span className="h-9 w-9 sm:h-11 sm:w-11 rounded-full bg-[#e6e6e6] flex items-center justify-center text-orange-600 shrink-0
					...
					<div className="bg-[#e6e6e6] rounded-xl sm:rounded-2xl p-3 sm:p-4 flex items-start gap-3
						shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]">
						<span className="h-9 w-9 sm:h-11 sm:w-11 rounded-full bg-[#e6e6e6] flex items-center justify-center text-emerald-600 shrink-0
							shadow-[2px_2px_4px_#c5c5c5,-2px_-2px_4px_#ffffff]">
							<FontAwesomeIcon icon={faTruck} className="text-sm sm:text-base" />
						</span>
						<div>
				...
				<div className="space-y-2.5 sm:space-y-3 text-sm text-gray-600">
					...
					<div className="flex items-center justify-between">
						<span>Shipping</span>
						<span className={`font-semibold ${shippingCost === 0 ? 'text-emerald-600' : 'text-gray-800'}`}>
							{shippingLabel}
						</span>
					</div>
					<div className="border-t border-dashed border-gray-300/60 pt-2.5 sm:pt-3 flex items-center justify-between text-base">
				...
				{/* Promo Code Section */}
				{hasDiscount ? (
					<div className="flex items-center justify-between p-3 bg-[#e6e6e6] rounded-xl
						shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]">
						<div className="flex items-center gap-2">
							<span className="h-8 w-8 rounded-lg bg-[#e6e6e6] text-emerald-600 flex items-center justify-center
								shadow-[2px_2px_4px_#c5c5c5,-2px_-2px_4px_#ffffff]">
						...
						<button
							...
							className="p-2 text-gray-400 hover:text-rose-500 rounded-lg bg-[#e6e6e6] transition-all
								shadow-[2px_2px_4px_#c5c5c5,-2px_-2px_4px_#ffffff]"
					...
					<div className="space-y-3">
						<div className="flex gap-2">
							<input
								...
								className="flex-1 h-11 px-4 rounded-xl bg-[#e6e6e6] outline-none transition-all text-sm
									shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]"
								disabled={isApplying}
							/>
							<button
								...
								disabled={isApplying}
								className="h-11 px-4 bg-[#e6e6e6] text-emerald-700 font-medium rounded-xl transition-all flex items-center gap-2 text-sm disabled:opacity-60
									shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]
						...
						{promoError && (
							<p className="text-xs text-rose-500 bg-[#e6e6e6] p-2 rounded-lg
					...
					<button
						...
						className="w-full h-11 sm:h-12 rounded-xl sm:rounded-2xl bg-[#e6e6e6] flex items-center justify-center gap-2 text-gray-600 hover:text-emerald-600 text-sm sm:text-base transition-all
							shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]"
					>
				...
				<Link
					href="/checkout"
					className="w-full h-11 sm:h-12 rounded-xl sm:rounded-2xl bg-[#e6e6e6] text-emerald-700 font-semibold flex items-center justify-center gap-2 text-sm sm:text-base transition-all
