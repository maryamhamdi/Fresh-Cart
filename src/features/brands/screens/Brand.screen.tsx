...
export default function BrandScreen({ brand, products }: BrandScreenProps) {
    ...
    const FilterSidebar = ({ isMobile = false }: { isMobile?: boolean }) => (
        <div className={`${isMobile ? '' : 'sticky top-24'}`}>
            <div className="bg-[#e6e6e6] rounded-2xl overflow-hidden shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]">
                {/* Filter Header */}
                <div className="p-4">
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            <span className="h-8 w-8 bg-[#e6e6e6] rounded-lg flex items-center justify-center shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]">
                                <FontAwesomeIcon icon={faFilter} className="h-3.5 w-3.5 text-violet-600" />
                            </span>
                ...
                <div className="p-4 pt-0 space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
                    {/* Categories Filter */}
                    {categories.length > 1 && (
                        <div className="pb-4">
                            <button
                                        ...
                                        <button
                                            ...
                                            className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all ${
                                                selectedCategory === category
                                                    ? 'text-violet-700 font-medium shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]'
                                                    : 'text-gray-600 hover:shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]'
                                            }`}
                                        >
                            ...
                            <div className="space-y-3">
                                <div className="flex gap-2">
                                    <input
                                        ...
                                        className="w-1/2 px-3 py-2 rounded-lg text-sm bg-[#e6e6e6] outline-none
                                            shadow-[inset_4px_4px_8px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.8)]
                                            focus:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]"
                                    />
                                    <input
                                        type="number"
                                        placeholder="Max"
        ...
        <section className="min-h-screen bg-[#e6e6e6]">
            ...
            <div className="bg-[#e6e6e6] py-10 sm:py-14 shadow-[inset_0_-6px_12px_rgba(0,0,0,0.04)]">
                <div className="container mx-auto px-4">
                    ...
                    <Link 
                        href="/brands" 
                        className="inline-flex items-center gap-2 text-gray-500 hover:text-violet-600 text-sm mb-4 transition-colors"
                    >
                    ...
                    <div className="flex items-center gap-5">
                        {/* Brand Logo */}
                        <div className="h-20 w-20 sm:h-24 sm:w-24 bg-[#e6e6e6] rounded-2xl flex items-center justify-center p-3
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="bg-[#e6e6e6] rounded-2xl p-4 mb-6 shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]">
                    <div className="flex flex-col lg:flex-row gap-4">
                        ...
                        <div className="flex-1 relative">
                            ...
                            <input
                                ...
                                className="w-full pl-11 pr-4 py-2.5 rounded-xl text-sm bg-[#e6e6e6] outline-none
                                    shadow-[inset_4px_4px_8px_rgba(0,0,0,0.1),inset_-4px_-4px_8px_rgba(255,255,255,0.8)]
                                    focus:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]"
                            />
                        </div>
                        ...
                        <div className="flex gap-3">
                            ...
                            <button
                                ...
                                className="lg:hidden flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-700 bg-[#e6e6e6]
                            ...
                            <div className="relative">
                                <button
                                    ...
                                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-700 bg-[#e6e6e6]
                                        shadow-[4px_4px_8px_#c5c5c5,-4px_-4px_8px_#ffffff]
                                        active:shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff] transition-all"
                                >
                                            ...
                                            {sortOptions.map(option => (
                                                <button
                                                    ...
                                                    className={`w-full text-left px-4 py-2.5 text-sm transition-colors ${
                                                        sortBy === option.value
                                                            ? 'text-violet-700 font-medium shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]'
                                                            : 'text-gray-700 hover:shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]'
                                                    }`}
                                                >
                                                    {option.label}
                                                </button>
                            ...
                            {/* View Mode Toggle */}
                            <div className="hidden sm:flex items-center gap-1 bg-[#e6e6e6] rounded-xl p-1
                                shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]">
                                <button
                                    onClick={() => setViewMode('grid')}
                                    className={`p-2 rounded-lg transition-colors ${
                                        viewMode === 'grid' 
                                            ? 'text-violet-600 bg-[#e6e6e6] shadow-[2px_2px_4px_#c5c5c5,-2px_-2px_4px_#ffffff]' 
                        ...
                        {hasActiveFilters && (
                            <div className="flex flex-wrap gap-2">
                                {selectedCategory !== 'all' && (
                                    <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium text-violet-700
                ...
                <div className="fixed inset-0 z-50 lg:hidden">
                    ...
                    <div className="absolute right-0 top-0 bottom-0 w-full max-w-sm bg-[#e6e6e6] overflow-y-auto">
                        <div className="sticky top-0 bg-[#e6e6e6] p-4 flex items-center justify-between
                            ...
                            <button 
                                onClick={() => setIsMobileFilterOpen(false)}
                                className="h-9 w-9 rounded-lg flex items-center justify-center bg-[#e6e6e6]
                        ...
                        <div className="sticky bottom-0 bg-[#e6e6e6] p-4 shadow-[0_-4px_8px_rgba(0,0,0,0.06)]">
                            <button
                                onClick={() => setIsMobileFilterOpen(false)}
                                className="w-full py-3 rounded-xl font-medium text-violet-700 bg-[#e6e6e6]
                                    shadow-[4px_4px_8px_#c5c5c5,-4px_-4px_8px_#ffffff]
                                    active:shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff] transition-all"
                            >
