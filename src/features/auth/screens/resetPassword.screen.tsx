                    ...
                    <div className="hidden lg:flex flex-col items-center justify-center p-8 xl:p-12">
                        ...
                        <div className="relative mb-8">
                            <div className="w-64 h-64 xl:w-80 xl:h-80 bg-[#e6e6e6] rounded-full flex items-center justify-center
                                ...
                                <FontAwesomeIcon icon={faUnlockKeyhole} className="text-emerald-600 text-7xl xl:text-8xl" />
                            </div>
                            {/* Floating Elements */}
                            ...
                            <div className="absolute -bottom-2 -left-6 w-14 h-14 bg-[#e6e6e6] rounded-xl flex items-center justify-center
                                shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]">
                                <FontAwesomeIcon icon={faShieldHalved} className="text-amber-500 text-xl" />
                            </div>
                        </div>
                        ...
                        <div className="text-center max-w-md">
                            ...
                            {/* Security Tips */}
                            <div className="bg-[#e6e6e6] rounded-2xl p-6 text-left
                                ...
                                <ul className="space-y-2 text-sm text-gray-600">
                                    <li className="flex items-center gap-2">
                                        <span className={`w-1.5 h-1.5 rounded-full ${passwordValue?.length >= 8 ? 'bg-emerald-500' : 'bg-gray-400'}`}></span>
                                        At least 8 characters long
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className={`w-1.5 h-1.5 rounded-full ${/[a-z]/.test(passwordValue || '') ? 'bg-emerald-500' : 'bg-gray-400'}`}></span>
                                    ...
                                    <li className="flex items-center gap-2">
                                        <span className={`w-1.5 h-1.5 rounded-full ${/[0-9]/.test(passwordValue || '') ? 'bg-emerald-500' : 'bg-gray-400'}`}></span>
                                        One number
                                    </li>
                                    <li className="flex items-center gap-2">
                                        <span className={`w-1.5 h-1.5 rounded-full ${/[!@#$%^&*()\[\]{}\-_+=~`|:;"'<>,./?]/.test(passwordValue || '') ? 'bg-emerald-500' : 'bg-gray-400'}`}></span>
                                    ...
                                    <>
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full pl-11 pr-12 py-3.5 bg-[#e6e6e6] rounded-xl focus:outline-none transition-all text-gray-800 placeholder:text-gray-400
                                                            shadow-[inset_4px_4px_8px_#c5c5c5,inset_-4px_-4px_8px_#ffffff]
                                                            ${errors.newPassword ? 'ring-2 ring-red-300' : ''}`}
                                                ...
                                                {passwordValue && (
                                                    <div className="mt-3">
                                                        ...
                                                        <div className="flex gap-1 bg-[#e6e6e6] rounded-full p-1
                                            ...
                                            <button
                                                type="submit"
                                                disabled={isLoading}
                                                className="w-full bg-[#e6e6e6] text-emerald-700 font-semibold py-3.5 px-6 rounded-xl transition-all disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 mt-6
                                                    shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]
                                        ...
                                        <div className="lg:hidden mt-6 p-4 bg-[#e6e6e6] rounded-xl
                                            ...
                                            <ul className="space-y-1.5 text-xs text-gray-600">
                                                <li className="flex items-center gap-2">
                                                    <FontAwesomeIcon
                                                        icon={faCircleCheck}
                                                        className={passwordValue?.length >= 8 ? 'text-emerald-500' : 'text-gray-400'}
                                                    />
                                                ...
                                                <li className="flex items-center gap-2">
                                                    <FontAwesomeIcon
                                                        icon={faCircleCheck}
                                                        className={/[a-z]/.test(passwordValue || '') ? 'text-emerald-500' : 'text-gray-400'}
                                                    />
                                                    One lowercase letter
                                                </li>
                                                <li className="flex items-center gap-2">
                                                ...
                                                <li className="flex items-center gap-2">
                                                    <FontAwesomeIcon
                                                        icon={faCircleCheck}
                                                        className={/[0-9]/.test(passwordValue || '') ? 'text-emerald-500' : 'text-gray-400'}
                                                    />
                                                    One number
                                                </li>
                                                <li className="flex items-center gap-2">
                                                    <FontAwesomeIcon
                                                        icon={faCircleCheck}
                                                        className={/[!@#$%^&*()\[\]{}\-_+=~`|:;"'<>,./?]/.test(passwordValue || '') ? 'text-emerald-500' : 'text-gray-400'}
                                                    />
                                                    One special character
                                                </li>
                                            </ul>
