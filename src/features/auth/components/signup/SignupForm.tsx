        ...
        <div className="flex items-center justify-center py-8 px-4">
            <div className="w-full max-w-lg">
                ...
                {isCreated ? (
                    ...
                    <form
                        className="rounded-2xl bg-[#e6e6e6] shadow-[8px_8px_16px_#c5c5c5,-8px_-8px_16px_#ffffff] border border-gray-100 p-6 sm:p-8 space-y-6 transition-all duration-300 hover:shadow-2xl"
                        onSubmit={handleSubmit(onSubmit)}
                    >
                        {/* Header */}
                        <header className="text-center space-y-2">
                            <h2 className="text-2xl sm:text-3xl font-bold text-[#004643]">Create Account</h2>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        id="name"
                                        className={`w-full pl-11 pr-4 py-3  bg-[#e6e6e6] text-gray-600
outline-none
shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]
focus:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,1)]
                                            border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${errors.name ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                            }`}
                                        {...register('name')}
                                    />
                                </div>
...
shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]
focus:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,1)]
                                            border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${errors.email ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                            }`}
                                        {...register('email')}
                                    />
                                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        id="password"
                                        className={`w-full pl-11 pr-12 py-3  bg-[#e6e6e6] text-gray-600
outline-none 
shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]
focus:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,1)]
                                            border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${errors.password ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                            }`}
                                        {...register('password')}
                                    />
                                    <button
...
shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]
focus:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,1)]
                                            border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${errors.rePassword ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                            }`}
                                        {...register('rePassword')}
                                    />
                                    <button
...
shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]
focus:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,1)]
                                            border rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all ${errors.phone ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                            }`}
                                        {...register('phone')}
                                    />
                                </div>
                        ...
                        <button
                            ...
                            className="w-full flex items-center justify-center gap-2 px-6 py-3.5 hover:bg-emerald-700  rounded-xl bg-[#e6e6e6] text-[#004643] font-medium
shadow-[6px_6px_12px_rgba(0,0,0,0.2),-6px_-6px_12px_rgba(255,255,255,0.9)]
hover:shadow-[inset_-2px_-2px_8px_rgba(255,255,255,1),inset_-2px_-2px_12px_rgba(255,255,255,0.5),inset_2px_2px_4px_rgba(255,255,255,0.1),inset_2px_2px_8px_rgba(0,0,0,0.3)] hover:text-white
active:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.2),inset_-4px_-4px_8px_rgba(255,255,255,1)]
transition group"
                        >
                            {isSubmitting ? (
                                <>
