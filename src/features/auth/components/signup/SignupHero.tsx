    ...
    return (
        <div className="hidden lg:flex flex-col items-center justify-center p-8 xl:p-12 ">
            ...
            <div className="relative mb-8">
                <div className="w-64 h-64 xl:w-80 xl:h-80 bg-gradient-to-br from-[#004643] to-[#00311F] shadow-[8px_8px_20px_rgba(0,0,0,0.4),-6px_-6px_16px_rgba(255,255,255,0.1)] rounded-full flex items-center justify-center">
                    <FontAwesomeIcon icon={faUserPlus} className="text-white text-7xl xl:text-8xl" />
                </div>
                
                {/* Floating Elements */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-[#043222] rounded-2xl flex items-center justify-center shadow-lg animate-bounce">
            ...
            <div className="text-center max-w-md">
                <h2 className="text-2xl xl:text-3xl font-bold text-[#3E2723] mb-4">
                    Join Our Community
                </h2>
                ...
                <div className="mt-8 space-y-3">
                    <div className="flex items-center justify-center gap-2 text-sm text-gray-700 bg-white/60 backdrop-blur-sm p-3 border border-gray-200 rounded-xl hover:bg-emerald-700 bg-[#e6e6e6] font-medium
