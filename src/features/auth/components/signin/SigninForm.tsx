        ...
        <div className="flex items-center justify-center py-8 px-4">
            <div className="w-full max-w-lg">
                ...
                {isSuccess ? (
                    ...
                    <form 
                        className="bg-[#e6e6e6]  shadow-[8px_8px_16px_#c5c5c5,-8px_-8px_16px_#ffffff] rounded-2xl border border-gray-100 p-6 sm:p-8 space-y-6 transition-all duration-300 hover:shadow-2xl" 
                        onSubmit={handleSubmit(onSubmit)}
                    >
                    {/* Header */}
                    <header className="text-center space-y-2">
                        <h2 className="text-2xl sm:text-3xl font-bold text-[#004643]">Welcome Back!</h2>
...
outline-none transition
shadow-[inset_4px_4px_8px_rgba(0,0,0,0.15),inset_-4px_-4px_8px_rgba(255,255,255,0.9)]
focus:shadow-[inset_2px_2px_4px_rgba(0,0,0,0.2),inset_-2px_-2px_4px_rgba(255,255,255,1)] rounded-xl text-sm ${
                        ...
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                                <input 
                                    id="keepme"
                                    type='checkbox'
                                    className="h-4 w-4 rounded border-gray-300 bg-[#e6e6e6]  shadow-[4px_4px_8px_rgba(0,0,0,0.2),-4px_-4px_8px_rgba(255,255,255,0.9)]
  peer-checked:shadow-[inset_4px_4px_6px_rgba(0,0,0,0.2),inset_-4px_-4px_6px_rgba(255,255,255,1)]"
                                    {...register('keepme')} 
                                />
                            ...
                            <Link 
                                ...
                                className="text-sm text-[#004643] font-medium transition-all duration-300 hover:underline hover:underline-offset-2"
                            >
                                Forgot password?
                            </Link>
                        </div>
...
transition group"
                    ...
                    <p className="text-center text-sm text-gray-500">
                        New to FreshCart?{' '}
                        <Link href="/signup" className="text-[#004643] font-semibold transition-all duration-300 hover:underline hover:underline-offset-2">
                            Create an account
                        </Link>
                    </p>
                </form>
