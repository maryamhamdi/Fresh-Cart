    ...
    return (
        <div className="hidden lg:flex flex-col items-center justify-center p-8 xl:p-12 ">
            ...
            <div className="relative mb-8">
                <div className="w-64 h-64 xl:w-80 xl:h-80 bg-gradient-to-br from-[#004643] to-[#00311F]  rounded-full flex items-center justify-center shadow-[8px_8px_20px_rgba(0,0,0,0.4),-6px_-6px_16px_rgba(255,255,255,0.1)]">
