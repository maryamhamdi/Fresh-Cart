...
function WishlistScreen() {
    ...
    if (typeof isLoading !== "undefined" && isLoading) {
        return (
            <section className="wishlist bg-[#e6e6e6] px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        return (
            <section className="wishlist bg-[#e6e6e6] px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
                <div className="flex flex-col items-center justify-center py-24 text-center">
                    <div className="h-20 w-20 rounded-full bg-[#e6e6e6] flex items-center justify-center mb-6
                    ...
                    <button
                        ...
                        className="bg-[#e6e6e6] text-emerald-700 font-semibold py-3 px-6 rounded-xl transition-all
        ...
        <section className="wishlist bg-[#e6e6e6] px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            {wishlistItems.length === 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-16 text-center" data-aos="zoom-in">
                    <div className="h-32 w-32 rounded-full bg-[#e6e6e6] flex items-center justify-center mb-6
                    ...
                    <Link
                        href="/shop"
                        className="bg-[#e6e6e6] text-emerald-700 font-semibold py-3.5 px-8 rounded-xl transition-all flex items-center gap-2
                            shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]
                ...
                <>
                    {/* Table - Desktop */}
                    <div className="hidden md:block bg-[#e6e6e6] rounded-2xl overflow-hidden
                        shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]">
                        {/* Table Header */}
                        <div className="grid grid-cols-[2fr_1fr_1fr_1fr] gap-4 px-6 py-4
                            shadow-[inset_0_-3px_6px_rgba(0,0,0,0.04)]">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-4">
                                        <Link href={`/products/${product._id}`}>
                                            <div className="relative h-20 w-20 rounded-lg bg-[#e6e6e6] overflow-hidden shrink-0
                                        ...
                                        <div>
                                            <Link
                                                ...
                                                className="font-semibold text-gray-800 hover:text-emerald-600 transition-colors line-clamp-1"
                                            >
                                                {product.title}
                                            </Link>
                                    ...
                                    <div className="flex items-center justify-center gap-2">
                                        {isInCart(product._id) ? (
                                            <Link
                                                href="/cart"
                                                className="inline-flex items-center gap-2 bg-[#e6e6e6] text-gray-700 font-medium text-sm px-4 py-2.5 rounded-lg transition-all
                                            ...
                                            <button
                                                ...
                                                className="inline-flex items-center gap-2 bg-[#e6e6e6] text-emerald-700 font-medium text-sm px-4 py-2.5 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed
                                                    shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]
                                                    active:shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]"
                                            >
                                                <FontAwesomeIcon icon={faCartShopping} className="text-xs" />
                                        ...
                                        <button
                                            ...
                                            className="p-2.5 text-gray-400 hover:text-red-500 rounded-lg bg-[#e6e6e6] transition-all
                    ...
                    <div className="md:hidden space-y-4">
                        {wishlistItems.map((product, idx) => (
                            <div
                                key={product._id}
                                className="bg-[#e6e6e6] rounded-xl p-4
                                    shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]"
                                data-aos="fade-up"
                                data-aos-delay={100 + idx * 50}
                            >
                                ...
                                <div className="flex gap-4">
                                    <Link href={`/products/${product._id}`}>
                                        <div className="relative h-24 w-24 rounded-lg bg-[#e6e6e6] overflow-hidden shrink-0
                                            shadow-[inset_3px_3px_6px_rgba(0,0,0,0.08),inset_-3px_-3px_6px_rgba(255,255,255,0.7)]">
                                            <Image
                                                src={product.imageCover}
                                                alt={product.title}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-start justify-between gap-2">
                                            <div className="min-w-0">
                                                <Link
                                                    href={`/products/${product._id}`}
                                                    className="font-semibold text-gray-800 hover:text-emerald-600 transition-colors line-clamp-2 text-sm"
                                                >
                                                    {product.title}
                                                </Link>
                                            ...
                                            <button
                                                onClick={() => handleRemoveItem(product._id, product.title)}
                                                className="p-2 text-gray-400 hover:text-red-500 rounded-lg bg-[#e6e6e6] transition-all shrink-0
                                                    shadow-[2px_2px_4px_#c5c5c5,-2px_-2px_4px_#ffffff]"
                                                title="Remove from wishlist"
                                            >
                                        ...
                                        <div className="flex items-center justify-between mt-2">
                                            ...
                                            <div>
                                                {isInCart(product._id) ? (
                                                    <span className="inline-flex items-center gap-1 text-xs text-emerald-600 bg-[#e6e6e6] px-2 py-1 rounded-full
                                                    ...
                                                    <span className="inline-flex items-center gap-1 text-xs text-red-500 bg-[#e6e6e6] px-2 py-1 rounded-full
                                                        shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]">
                                ...
                                <div className="mt-4">
                                    {isInCart(product._id) ? (
                                        <Link
                                            href="/cart"
                                            className="w-full inline-flex items-center justify-center gap-2 bg-[#e6e6e6] text-gray-700 font-medium text-sm py-2.5 rounded-lg transition-all
                                                shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]
                                                active:shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]"
                                        >
                                            <FontAwesomeIcon icon={faCheck} className="text-xs" />
                                        ...
                                        <button
                                            onClick={() => handleAddToCart(product._id)}
                                            disabled={product.quantity === 0}
                                            className="w-full inline-flex items-center justify-center gap-2 bg-[#e6e6e6] text-emerald-700 font-medium text-sm py-2.5 rounded-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed
                                                shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]
                                                active:shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]"
                                        >
                                            <FontAwesomeIcon icon={faCartShopping} className="text-xs" />
