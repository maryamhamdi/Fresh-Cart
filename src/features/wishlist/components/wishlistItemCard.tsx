...
export default function WishlistItemCard({ product, onRemove }: WishlistItemCardProps) {
    ...
    return (
        <article className="bg-[#e6e6e6] rounded-2xl p-5 flex flex-col sm:flex-row gap-5 transition-shadow
            ...
            <div className="flex flex-col items-center gap-3 shrink-0">
                <Link href={`/products/${_id}`} className="relative">
                    <div className="relative h-36 w-36 rounded-xl bg-[#e6e6e6] overflow-hidden
            ...
            <div className="flex-1 space-y-3">
                <Link href={`/products/${_id}`}>
                    <h3 className="text-lg font-semibold text-gray-800 leading-snug hover:text-emerald-600 transition-colors line-clamp-2">
                        {title}
                    </h3>
                </Link>
            ...
            <div className="flex sm:flex-col items-center sm:items-end justify-between sm:justify-center gap-3">
                ...
                <button
                    ...
                    disabled={quantity === 0}
                    type="button"
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#e6e6e6] text-emerald-700 font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed
