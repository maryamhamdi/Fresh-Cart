...
export default function RelevantProducts({ products, title = "You May Also Like" }: RelevantProductsProps) {
    ...
    return (
        <section className="container mx-auto px-4 py-6 sm:py-8 lg:py-12">
            {/* Section Background */}
            <div className="bg-[#e6e6e6] rounded-2xl sm:rounded-3xl p-4 sm:p-6 lg:p-8
                shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]">
                {/* Header */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5 sm:mb-6">
                    <div className="flex items-center gap-3">
                        <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-[#e6e6e6] flex items-center justify-center shrink-0
                            shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]">
                            <FontAwesomeIcon icon={faWandSparkles} className="h-4 w-4 sm:h-5 sm:w-5 text-emerald-600" />
                        </div>
                    ...
                    <div className="flex items-center gap-2">
                        <button
                            className="relevant-prev h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-[#e6e6e6] flex items-center justify-center text-gray-500 hover:text-emerald-600 transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed
                                shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]
                        ...
                        <button
                            className="relevant-next h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-[#e6e6e6] flex items-center justify-center text-gray-500 hover:text-emerald-600 transition-all duration-200 disabled:opacity-40 disabled:cursor-not-allowed
                                shadow-[3px_3px_6px_#c5c5c5,-3px_-3px_6px_#ffffff]
                                active:shadow-[inset_2px_2px_4px_#c5c5c5,inset_-2px_-2px_4px_#ffffff]"
