...
export function CategoryCardSkeleton() {
    return (
        <div className="bg-[#e6e6e6] rounded-2xl overflow-hidden
            ...
            {/* Image Skeleton */}
            <div className="aspect-square m-3 rounded-xl bg-[#dcdcdc] animate-pulse
                shadow-[inset_4px_4px_8px_rgba(0,0,0,0.06),inset_-4px_-4px_8px_rgba(255,255,255,0.6)]"></div>
            {/* Name Skeleton */}
            <div className="p-3 sm:p-4 text-center">
                <div className="h-4 w-20 bg-[#dcdcdc] rounded animate-pulse mx-auto"></div>
            </div>
        </div>
    )
}
...
export function FeaturedCategoryCardSkeleton() {
    return (
        <div className="bg-[#e6e6e6] rounded-2xl p-6 flex items-center gap-4
            shadow-[6px_6px_12px_#c5c5c5,-6px_-6px_12px_#ffffff]">
            <div className="h-20 w-20 bg-[#dcdcdc] rounded-xl animate-pulse shrink-0"></div>
            <div className="flex-1 min-w-0 space-y-2">
                <div className="h-5 w-32 bg-[#dcdcdc] rounded animate-pulse"></div>
                <div className="h-4 w-20 bg-[#dcdcdc] rounded animate-pulse"></div>
            </div>
            <div className="h-10 w-10 bg-[#dcdcdc] rounded-full animate-pulse"></div>
        </div>
    )
}
        ...
        <div className="bg-[#e6e6e6] py-10 sm:py-14 shadow-[inset_0_-6px_12px_rgba(0,0,0,0.04)]">
            <div className="container mx-auto px-4">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800">Browse Categories</h1>
                </div>
                <p className="text-gray-500 text-sm sm:text-base">Loading categories...</p>
            </div>
        </div>
    )
}
        ...
        <div className="bg-[#e6e6e6] rounded-2xl p-4 sm:p-6 mb-8
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                    <div className="h-12 w-12 bg-[#dcdcdc] rounded-xl animate-pulse"></div>
                    <div className="space-y-2">
                        <div className="h-6 w-12 bg-[#dcdcdc] rounded animate-pulse"></div>
                        <div className="h-4 w-24 bg-[#dcdcdc] rounded animate-pulse"></div>
                    </div>
                </div>
                <div className="h-10 w-36 bg-[#dcdcdc] rounded-xl animate-pulse"></div>
            </div>
        </div>
    )
}
            ...
            <div className="container mx-auto px-4 py-8 sm:py-12">
                ...
                <div className="mt-12">
                    <div className="flex items-center gap-3 mb-6">
                        ...
                        <div className="h-7 w-48 bg-[#dcdcdc] rounded animate-pulse"></div>
                    </div>
