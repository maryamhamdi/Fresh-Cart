...
import slider2 from '../../../assets/images/home-slider-2.jpeg'
import slider3 from '../../../assets/images/home-slider-3.jpeg'
...
export default function Slider() {
    return <>
        <section className="slider relative">
                ...
                <SwiperSlide>
                    <div className='py-45 relative h-64 w-full'>
                        <Image
                            ...
                            priority
                        />
                        <div className="absolute inset-0 z-10 flex flex-col justify-center text-white  bg-gradient-to-r from-emerald-700/80 via-emerald-600/50 to-transparent">
                    ...
                    <div className='py-45 relative h-64 w-full'>
                        ...
                        <div className="absolute inset-0 z-10 flex flex-col justify-center text-white bg-gradient-to-r from-emerald-700/80 via-emerald-600/50 to-transparent">
                            <div className='container space-y-4 flex flex-col justify-center' data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div className='flex gap-2'>
                                    <Link href={`/shop`}>
                                        <button className="btn px-5 py-2 bg-white text-[#1a0498]">Order Now</button>
                                    </Link>
            ...
            <div className="custom-prev absolute left-4 top-[90%] -translate-y-1/2 z-20 cursor-pointer bg-white/90 hover:bg-white/80 rounded-full size-12 hidden sm:flex items-center justify-center">
                <FontAwesomeIcon icon={faChevronLeft} className='text-[#024e39] text-xl' />
            </div>
            <div className="custom-next absolute right-4 top-[90%] -translate-y-1/2 z-20 cursor-pointer bg-white/90 hover:bg-white/80 rounded-full size-12 hidden sm:flex items-center justify-center">
                <FontAwesomeIcon icon={faChevronLeft} className='text-[#024e39] text-xl rotate-180' />
            </div>
        </section>
