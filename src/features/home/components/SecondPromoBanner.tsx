        ...
        <div className="">
            <div className="container py-5 mt-10">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 ">
                    <div className="flex items-center gap-4 shadow-md hover:shadow-[#004643] hover:scale-105 transition-all duration-200 py-4 ps-4 rounded-lg bg-transparent">
                        <div className="size-12 flex items-center justify-center bg-blue-200/20 text-blue-500 group-hover:scale-110 group-hover:shadow-md group-hover:shadow-blue-400/40 transition-all duration-100 rounded-full">
