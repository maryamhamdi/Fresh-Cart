...
export default function Categories() {
    ...
    return (
        <section className="categories py-10  container">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 py-10">
                {loading ? (
                    ...
                    categories.map((category: any) => (
                        <Link key={category._id} href={`/shop?category=${category._id}`} className="cart shadow shadow-lime-950 hover:shadow-lg py-4 px-5 rounded-lg flex flex-col items-center justify-center transition-all duration-300 hover:-translate-y-1">
