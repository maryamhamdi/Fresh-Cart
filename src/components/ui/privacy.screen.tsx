      ...
      <section className="max-w-6xl mx-auto py-8 px-4 bg-[#e6e6e6]">
        <div className="mb-6">
          <div className="bg-[#e6e6e6] rounded-xl sm:rounded-2xl p-4 flex items-start gap-4
            ...
            <div className="h-10 w-10 rounded-lg bg-[#e6e6e6] flex items-center justify-center text-emerald-600 shrink-0
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          <Link href="/terms" className="inline-block bg-[#e6e6e6] text-emerald-700 font-semibold px-5 py-2 rounded-full transition-all
            shadow-[5px_5px_10px_#c5c5c5,-5px_-5px_10px_#ffffff]
            active:shadow-[inset_3px_3px_6px_#c5c5c5,inset_-3px_-3px_6px_#ffffff]">View Terms of Service →</Link>
        </div>

        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-10">
          <div className="bg-[#e6e6e6] rounded-2xl p-4 text-center transition-all
